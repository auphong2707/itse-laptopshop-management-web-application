        ...
        <Row gutter={[32, 32]} justify="center">
          ...
          <Col xs={24} md={7} style={{ paddingLeft:"4px", paddingRight: "41px"}}>
            <div style={{ background: '#F5F7FF', padding: '20px', minHeight: '200px' }}>
              <Title level={3} style={{margin:"0px 0"}}>Summary</Title>
              ...
              <Text style={{ float: 'right' }}>{formatPrice(0.05 * totalPrice)}</Text>
              <br />
              <Text strong>GST (10%)</Text>
              <Text style={{ float: 'right' }}>{formatPrice(0.1 * totalPrice)}</Text>
              <Divider style={{ marginBottom: "18px"}} />
              <Title level={3} style={{ marginTop: "12px"}} >
                Order Total: <span style={{ float: 'right' }}>{formatPrice(50000+1.15*(totalPrice))}</span>
              </Title>
              <Button 
                type="primary"
                block
