import {
  ...
  const brands = [
    { name: "asus", logo: "/brand-logo/asus-logo.png", link: "/admin/catalog/asus" },
    {
      name: "lenovo",
      logo: "/brand-logo/lenovo-logo.png",
      link: "/admin/catalog/lenovo",
    },
    { name: "acer", logo: "/brand-logo/acer-logo.png", link: "/admin/catalog/acer" },
    { name: "dell", logo: "/brand-logo/dell-logo.png", link: "/admin/catalog/dell" },
