				...
				{features.map((feature, index) => (
					<Col xs={24} sm={12} md={8} key={index}>
						<div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
							...
							<Paragraph style={{ width: "60%", fontSize:16}}>{feature.description}</Paragraph>
						</div>
					</Col>
				))}
			</div>

			<div style={{ background: "#000", color: "#fff", paddingTop: "15px", paddingBottom: "10px" }} className="responsive-padding">
				{/* Newsletter Section */}
              ...
              {messageText && (
				...
				<Row gutter={[40, 20]}>
					<Col xs={24} sm={12} md={6}>
						...
						<Text style={{ display: "block", color: "#bbb" }}>Privacy Policy</Text>
						<Text style={{ display: "block", color: "#bbb" }}>Contact Us</Text>
						<Text style={{ display: "block", color: "#bbb" }}>Newsletter Subscription</Text>
					</Col>

					<Col xs={24} sm={12} md={6}>
						<Title level={5} style={{ color: "#fff" }}>PC Parts</Title>
						<Text style={{ display: "block", color: "#bbb" }}>CPUs</Text>
						<Text style={{ display: "block", color: "#bbb" }}>Graphic Cards</Text>
						<Text style={{ display: "block", color: "#bbb" }}>RAM (Memory)</Text>
						<Text style={{ display: "block", color: "#bbb" }}>Motherboards</Text>
					</Col>

					<Col xs={24} sm={12} md={6}>
						<Title level={5} style={{ color: "#fff" }}>Laptops</Title>
						<Text style={{ display: "block", color: "#bbb" }}>Everyday Use Notebooks</Text>
						<Text style={{ display: "block", color: "#bbb" }}>Gaming Laptops</Text>
						<Text style={{ display: "block", color: "#bbb" }}>Workstation Laptops</Text>
					</Col>

					<Col xs={24} sm={12} md={6}>
						<Title level={5} style={{ color: "#fff" }}>Address</Title>
						...
						<Text style={{ display: "block", color: "#bbb" }}>
							E-mail: <Link href="mailto:shop@email.com" style={{ color: "#007BFF" }}>shop@email.com</Link>
						</Text>
					</Col>
				</Row>
				...
				<Row justify="space-between" align="middle" style={{ marginTop: 10 }}>
					<Col>
						<FacebookOutlined style={{ fontSize: "20px", color: "#fff", marginRight: "10px" }} />
